						...
						<div class="row">
							<div class="form-inline">
								<div class="form-group">
									...
									<div class="input-group">
										<input readonly="readonly" required="required" name="name" type="text"
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input readonly="readonly" required="required" name="num" type="text"
								...
								<div class="form-group">
									...
									<select disabled="disabled" class="selectpicker" name="collegeId">
							...
							<div class="form-inline">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input readonly="readonly" required="required" name="idCardNo" type="text"
											class="form-control wk-normal-input"  value="${student.idCardNo}"
											placeholder="请输入身份证号" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label wk-filed-label">学生性别: </label>
									<select class="selectpicker" name="gender" disabled="disabled">
