    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-tabs wk-nav-menu" id="wk-nav-menu">
                <li role="presentation"><a id="leftNav">[教师:欢迎登录${user.name }]</a></li>
                            ...
                            <div class="panel-heading"> 
                             ...
                             <div id="BMenu" class="panel-collapse collapse">    
                                <div class="list-group wk-accordion-list-group">
                                    ...
                                    <button type="button" class="list-group-item" id="wk-menu-panel-item-searchStudentFileInfo"> >&nbsp;&nbsp;下载学生作业</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-info wk-accordion-header">
                            ...
                            <div id="CMenu" class="panel-collapse collapse">    
                                <div class="list-group wk-accordion-list-group">
                                    ...
                                    <button type="button" class="list-group-item" id="wk-menu-panel-item-searchDiscuss"> >&nbsp;&nbsp;讨论信息管理</button>
