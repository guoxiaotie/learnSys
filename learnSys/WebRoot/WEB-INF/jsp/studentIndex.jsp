    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-tabs wk-nav-menu" id="wk-nav-menu">
                <li role="presentation"><a id="leftNav">[学生:欢迎登录${user.name }]</a></li>
                ...
                <li role="presentation"><a href="javascript:void();" id="wk-menu-panel-item-searchTaskInfo" class="wk-main-menu-item">完成考试</a></li>
	...
	<div class="row">
        <div class="col-lg-2" id="wk-menu-panel"  style="width: 15%;">
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel-group wk-accordion-panel-group" id="accordion">
                        ...
                        <div class="panel panel-info wk-accordion-header">
                            ...
                            <div id="CMenu" class="panel-collapse collapse">    
                                <div class="list-group wk-accordion-list-group">
                                    ...
                                    <button type="button" class="list-group-item" id="wk-menu-panel-item-createStudentFile"> >&nbsp;&nbsp;上传作业</button>
                                    <button type="button" class="list-group-item" id="wk-menu-panel-item-searchStudentFile"> >&nbsp;&nbsp;查询已上传作业</button>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-info wk-accordion-header">
                            <div class="panel-heading"> 
                                <a data-toggle="collapse" href="#AMenu" data-parent="#accordion">考试管理</a>
                            </div>
                            <div id="AMenu" class="panel-collapse collapse">    
                                <div class="list-group wk-accordion-list-group">
                                    <button type="button" class="list-group-item" id="wk-menu-panel-item-searchTaskInfo"> >&nbsp;&nbsp;完成考试</button>
         ...
         <div  id="rightTable" class="col-lg-10" style="padding:0px;">
            <iframe id="mainFrame" src="<%=basePath%>/searchNoticeInfoA.html" width="100%" frameborder="0" onload="changeFrameHeight()">
            </iframe>
         </div>
    </div>
